...
DB_INSTANCE_NAME="db_dev_${AWS_ACCOUNT_ID}"
...
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/terraform.tfvars ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/terraform.tfvars /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/terraform.tfvars.${TIMESTAMP}
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf.${TIMESTAMP}
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf.${TIMESTAMP}
...
echo "Your good to go! First ./main.sh dev, then ./Post_main.sh finally services.sh for a NON production provisioning"
...
cat > /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/terraform.tfvars << EOF
# Infrastructure configuration
...
db_storage        = 20
EOF
echo "Updated terraform.tfvars at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/terraform.tfvars"
...
if [ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf ]; then
    # Update the bucket name
    sed -i "s/bucket\s*=\s*\"bucket[0-9]\{12\}\"/bucket = \"${TF_STATE_BUCKET}\"/g" /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf
    
    echo "Updated backend.tf with the correct bucket name at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf"
else
    echo "Warning: backend.tf not found at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/backend.tf"
fi

# 6. Update main.tf subnet IDs
if [ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf ]; then
    ...
    done < /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf
    
    # Replace the original file with the updated one
    mv "$TMP_FILE" /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf
    
    echo "Updated main.tf with subnet IDs at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf"
else
    echo "Warning: main.tf not found at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/dev/main.tf"
fi
...
if [ -f /home/costas778/abc/trading-platform/install-alb-controller.sh ]; then
    sed -i 's/CLUSTER_NAME="abc-trading-prod"/CLUSTER_NAME="abc-trading-dev"/' /home/costas778/abc/trading-platform/install-alb-controller.sh
    echo "Updated install-alb-controller.sh with cluster name abc-trading-dev"
else
