...
DB_INSTANCE_NAME="db_staging_${AWS_ACCOUNT_ID}"
...
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/terraform.tfvars ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/terraform.tfvars /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/terraform.tfvars.${TIMESTAMP}
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf.${TIMESTAMP}
[ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf ] && cp /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf.${TIMESTAMP}
...
echo "Your good to go! First ./main.sh staging, then ./Post_main.sh finally services.sh for a NON production provisioning"
...
export DOMAIN_NAME="abc-trading-staging.com"
export HOSTED_ZONE_ID="${HOSTED_ZONE_ID}"

# Infrastructure configuration
export TF_STATE_BUCKET="${TF_STATE_BUCKET}"
export TF_LOCK_TABLE="terraform-state-lock"
export CLUSTER_NAME="abc-trading-staging"
...
# Application runtime configuration
BUILD_VERSION=1.0.0
DOMAIN_NAME=abc-trading-staging.com
...
CLUSTER_NAME="abc-trading-staging"
...
cat > /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/terraform.tfvars << EOF
# Infrastructure configuration
...
db_storage        = 20
EOF
echo "Updated terraform.tfvars at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/terraform.tfvars"
...
if [ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf ]; then
    # Update the bucket name
    sed -i "s/bucket\s*=\s*\"bucket[0-9]\{12\}\"/bucket = \"${TF_STATE_BUCKET}\"/g" /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf
    
    echo "Updated backend.tf with the correct bucket name at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf"
else
    echo "Warning: backend.tf not found at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/backend.tf"
fi

# 6. Update main.tf subnet IDs
if [ -f /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf ]; then
    ...
    done < /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf
    
    # Replace the original file with the updated one
    mv "$TMP_FILE" /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf
    
    echo "Updated main.tf with subnet IDs at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf"
else
    echo "Warning: main.tf not found at /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging/main.tf"
fi
...
if [ -f /home/costas778/abc/trading-platform/install-alb-controller.sh ]; then
    sed -i 's/CLUSTER_NAME="abc-trading-dev"/CLUSTER_NAME="abc-trading-staging"/' /home/costas778/abc/trading-platform/install-alb-controller.sh
    echo "Updated install-alb-controller.sh with cluster name abc-trading-staging"
else
...
if ! aws s3 ls "s3://${TF_STATE_BUCKET}" 2>&1 > /staging/null; then
...
cd /home/costas778/abc/trading-platform/infrastructure/terraform/environments/staging
